...
const Register = () => {
        ...
        const { fname,lname,idnum,email,pswd,cpswd,stphn,ptphn}=data;
        ...
        const submitHandler=(e)=>{
          ...
          var passw=  /^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{8,15}$/;
            ...
            else if(!(stphn.trim().length==10) || !(/\d/.test(stphn.trim())))
                alert("Invalid Student Phone Number" )
            else if(!(ptphn.trim().length==10) || !(/\d/.test(ptphn.trim())))
                alert("Invalid Parent Phone Number" )
           
          else{
              axios.post("http://localhost:5000/adddata",data).then(
      ...
      <div className="col-12 col-lg-9 col-xl-7">
        <div className="card shadow-2-strong card-registration" style={{borderRadius: "15px;"}}>
          <div className="card-body p-4 p-md-5">
            <h3 className="mb-4 pb-2 pb-md-0 mb-md-5"> Student Registration Form</h3>
  ...
  <select className="select" name="branch" onChange={changeHandler}>
    ...
    <option value="Mechanical">Mechanical</option>
              ...
              <div className="row">
                <div className="col-md-6 mb-4 pb-2">
                  ...
                  <label className="form-label" >Student Phone</label>
                    ...
                    {(stphn.length != 0 && (!(stphn.trim().length==10) || !(/\d/.test(stphn.trim()))))?<span style={{color:'red'}}>Invalid Phone Number</span>:''}
                  </div>
                ...
                <div className="col-md-6 mb-4 pb-2">
                  ...
                  <label className="form-label" >Parent Phone</label>
                    ...
                    {(ptphn.length != 0 && (!(ptphn.trim().length==10) || !(/\d/.test(ptphn.trim()))))?<span style={{color:'red'}}>Invalid Phone Number</span>:''}
              ...
              <input className="btn btn-primary btn-lg" type="submit" value="Register" />
               ...
               <p>Already Registered? Click <Link to ="/Login">Login</Link></p>
               </center>
